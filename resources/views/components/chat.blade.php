...
function initializeChat() {
    ...
    function toggleChat(show) {
        ...
        showChatButton.style.display = show ? "none" : "block";
    }

    // Event Listeners
    showChatButton.addEventListener("click", () => toggleChat(true));
    toggleChatButton.addEventListener("click", () => toggleChat(false));
    ...
    const emptyMsg = messagesContainer.querySelector(".message.received:empty");
